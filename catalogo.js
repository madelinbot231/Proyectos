document.addEventListener("DOMContentLoaded", () => {
  ...
  '<br>Cuando sus caminos se cruzan, surge un plan que parece perfecto: Simon fingirá cortejarla, ayudándola a captar la atención de los jóvenes londinenses, mientras Daphne actuará como su escudo ante las insistentes madres que desean un yerno. Pero lo que comienza como un acto cuidadosamente planeado se transforma en algo más profundo. La química entre ellos crece y las emociones, cada vez más intensas, se vuelven imposibles de ignorar.<br>'+
    ...
    const resenas = [
      { libro: "Los Margenes del Juego", comentario: "La historia se despliega en un torbellino de secretos oscuros, traiciones inesperadas y verdades que amenazan con desmoronar la vida de Poppy. Con personajes intrigantes, una trama llena de giros inesperados y una atmósfera cargada de peligro y pasión, esta historia atrapará a los lectores." },
      { libro: "Hechizado", comentario: "Un viaje emocional entre dos almas que se encuentran en circunstancias inesperadas. Su trama envuelve al lector en un universo de pasión y descubrimientos." },
      { libro: 'Inevitable destruccion', comentario: 'Es una historia que habla sobre el deseo prohibido, donde se envoscan en un amor en el cual alguien tiene que ganar el juego'},
    ];
    ...
    function renderizarLibros(lista) {
      ...
      lista.forEach((libro, indice) => {
        ...
        li.addEventListener("click", () => mostrarDescripcion(indice));
    ...
    function mostrarDescripcion(indice) {
      ...
      detalleLibro.innerHTML = `
        ...
        <button id="volverCatalogo" style="margin-top: 20px;">Volver al Catálogo</button>
      `;
